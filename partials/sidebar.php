...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item side-margin">
              <div class="text-center ic-cm"><i class="mdi mdi-folder-multiple-outline"></i></div>
              <a class="nav-link side-padding" href="<?php echo baseurl('admin/index.php');?>">
              <p class="menu-title st-sd">Dashboard</p>
              </a>
            </li>
            <li class="nav-item side-margin">
              <div class="text-center ic-cm"><i class=" mdi mdi-percent"></i></div>
              <a class="nav-link side-padding" href="<?php echo baseurl('admin/accuracy.php');?>">
              <p class="menu-title st-sd">Define <br> Accuracy</p>
              </a>
            </li>

            <li class="nav-item side-margin">
              <div class="text-center ic-cm"><i class="mdi mdi mdi-checkbox-marked-circle-outline"></i></div>
              <a class="nav-link side-padding" href="<?php echo baseurl('admin/add-questions.php');?>">
              <p class="menu-title st-sd">Add <br> Question</p>
              </a>
            </li>

            <li class="nav-item side-margin">
              <div class="text-center ic-cm"><i class="mdi mdi mdi-comment-multiple-outline"></i></div>
              <a class="nav-link side-padding" href="<?php echo baseurl('admin/questions-list.php');?>">
              <p class="menu-title st-sd">All <br> Questions</p>
              </a>
            </li>

            <li class="nav-item side-margin">
              <div class="text-center ic-cm"><i class="mdi mdi mdi-cube"></i></div>
              <a class="nav-link side-padding" href="<?php echo baseurl('admin/result.php');?>">
              <p class="menu-title st-sd">Test <br> Questions</p>
              </a>
            </li>
